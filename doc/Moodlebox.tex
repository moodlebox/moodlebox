...
\date{11 janvier 2017\footnote{Version 1.4.1}}
...
\begin{lstlisting}[language=bash]
$ sudo apt-get install nginx php5-fpm php5-cli php5-xmlrpc php5-curl php5-gd php5-intl php5-apcu
\end{lstlisting}
...
\begin{lstlisting}[language=bash]
$ sudo systemctl restart php5-fpm nginx
\end{lstlisting}
...
\end{lstlisting}
La dernière commande ci-dessus spécifie la branche installée par Git. Dans ce cas, il s'agit de la version 3.2.x stable actuelle.
