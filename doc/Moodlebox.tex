...
\date{9 août 2016\footnote{Version 1.1.1}}
...
\item Interface graphique pour redémarrer et éteindre la MoodleBox, ainsi que pour régler la date et l'heure de la MoodleBox (au moyen d'un plugin local de Moodle\footnote{\url{https://github.com/martignoni/moodlebox-plugin}.}).
...
/var/www/html/local/moodlebox/.set-server-datetime IN_MODIFY /bin/bash /var/www/html/local/moodlebox/.set-server-datetime
\end{lstlisting}
