...
\item Interface graphique pour redémarrer et éteindre la MoodleBox, ainsi que pour régler la date et l'heure de la MoodleBox (au moyen d'un plugin local de Moodle\footnote{\url{https://github.com/martignoni/moodlebox}.}).
