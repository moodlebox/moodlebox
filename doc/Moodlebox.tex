...
\date{11 septembre 2016\footnote{Version 1.3.1}}
...
\item Interface graphique pour redémarrer et éteindre la MoodleBox, pour changer le mot de passe, ainsi que pour régler la date et l'heure de la MoodleBox (au moyen d'un plugin d'administration de Moodle\footnote{\url{https://github.com/martignoni/moodlebox-plugin}.}).
...
Afin de permettre le redémarrage et l'arrêt de la MoodleBox sans risque de corruption de la carte microSD, la modification du mot de passe, le réglage de l'heure ainsi que pour donner des informations utiles sur son fonctionnement, on installe le plugin d'administration \emph{MoodleBox} pour Moodle\footnote{Plugin MoodleBox, version 1.3, \url{https://github.com/martignoni/moodlebox-plugin/releases/tag/v1.3}.}.
...
$ sudo touch .reboot-server; touch .shutdown-server; touch .set-server-datetime; touch .newpassword
