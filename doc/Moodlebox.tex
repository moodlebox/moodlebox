...
\date{xx juin 2017\footnote{Version 1.7b}} %% \footnote{Version \gitAbbrevHash, \gitAuthorDate}
...
$ mysql -u root -p'Moodlebox4$' moodle -e "truncate table moodle.mdl_upgrade_log"
$ sudo apt-get clean
