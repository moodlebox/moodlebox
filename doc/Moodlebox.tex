...
\date{21 août 2016\footnote{Version 1.3}}
...
\begin{verification}
La page \url{http://moodlebox.home/admin/environment.php} l'avertissement sur la conversion des tables en format Barracuda n'est plus affiché.
\end{verification}
